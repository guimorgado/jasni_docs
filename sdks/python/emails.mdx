...
```python
jasni.emails.delete(uid=123, account="me@mail.jasni.ai")
```
...
```python
# Mark as read
jasni.emails.mark_as_read(uid=123, account="me@mail.jasni.ai")

# Mark as unread
jasni.emails.mark_as_unread(uid=123, account="me@mail.jasni.ai")
```
