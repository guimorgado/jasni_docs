...
```python
try:
    jasni.emails.list(account="me@jasnimail.com")
...
```python
try:
    jasni.emails.get(uid=999999, account="me@jasnimail.com")
...
try:
    result = jasni.emails.get(uid=123, account="me@jasnimail.com")
...
# Usage
result = with_retry(
    lambda: jasni.emails.list(account="me@jasnimail.com")
)
```
...
with jasni_client("jsk_your_api_key") as jasni:
    result = jasni.emails.list(account="me@jasnimail.com")
