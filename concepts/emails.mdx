...
<AccordionGroup>
  <Accordion title="Use appropriate rate limiting" icon="/icons-svg/refresh.svg">
    Don't poll the inbox too frequently. Consider using webhooks for real-time notifications instead.
  </Accordion>
  
  <Accordion title="Handle threading correctly" icon="/icons-svg/message.svg">
    When building conversation views, group emails by their References header to maintain proper threading.
  </Accordion>
  
  <Accordion title="Validate email addresses" icon="/icons-svg/check.svg">
    Always validate recipient email addresses before sending to avoid bounces.
  </Accordion>
  
  <Accordion title="Use webhooks for incoming email" icon="/icons-svg/webhook.svg">
