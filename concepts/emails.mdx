...
<CardGroup cols={2}>
  <Card title="Send Email" icon="paper-plane" href="/api-reference/emails/send">
    Send email endpoint
  </Card>
  <Card title="List Emails" icon="inbox" href="/api-reference/emails/list">
