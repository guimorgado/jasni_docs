...
<AccordionGroup>
  <Accordion title="Use descriptive names" icon="/icons-svg/label.svg">
    Choose clear, descriptive label names that are easy to understand at a glance.
  </Accordion>
  
  <Accordion title="Limit the number of labels" icon="/icons-svg/info.svg">
    Too many labels can be overwhelming. Aim for 10-20 well-organized labels.
  </Accordion>
  
  <Accordion title="Use consistent colors" icon="/icons-svg/eye.svg">
    Establish a color scheme (e.g., red for urgent, green for resolved) and stick to it.
  </Accordion>
  
  <Accordion title="Combine with webhooks" icon="/icons-svg/webhook.svg">
...
<CardGroup cols={2}>
  <Card title="List Labels" icon="/icons-svg/label.svg" href="/api-reference/labels/list">
    List labels endpoint
  </Card>
  <Card title="Create Label" icon="/icons-svg/plus.svg" href="/api-reference/labels/create">
