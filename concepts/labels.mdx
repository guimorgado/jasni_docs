...
<CardGroup cols={2}>
  <Card title="List Labels API" icon="list" href="/api-reference/labels/list">
    List labels endpoint reference
  </Card>
  <Card title="Create Label API" icon="plus" href="/api-reference/labels/create">
    Create label endpoint reference
  </Card>
  <Card title="Emails" icon="envelope" href="/concepts/emails">
    Learn about email operations
  </Card>
