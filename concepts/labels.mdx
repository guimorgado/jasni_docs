...
<CardGroup cols={2}>
  ...
  <Card title="TypeScript SDK" icon="/icons-svg/code.svg" href="/sdks/typescript/labels">
    Full TypeScript SDK reference for labels
  </Card>
  <Card title="Python SDK" icon="/icons-svg/code.svg" href="/sdks/python/labels">
    Full Python SDK reference for labels
  </Card>
