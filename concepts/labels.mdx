...
<AccordionGroup>
  ...
  <Accordion title="Limit the number of labels" icon="list">
    Too many labels can be overwhelming. Aim for 10-20 well-organized labels.
  </Accordion>
  
  <Accordion title="Use consistent colors" icon="eye">
...
<CardGroup cols={2}>
  <Card title="List Labels" icon="tag" href="/api-reference/labels/list">
