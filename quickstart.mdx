...
<CardGroup cols={2}>
  <Card title="TypeScript SDK" icon="/icons-svg/code.svg" href="/sdks/typescript/overview">
    Full-featured TypeScript/Node.js SDK
  </Card>
  <Card title="Python SDK" icon="/icons-svg/code.svg" href="/sdks/python/overview">
