...
<ParamField query="label_ids" type="string">
  Comma-separated list of label IDs to filter by. Emails must have **all** specified labels.
</ParamField>

<ParamField query="labels" type="string">
  Comma-separated list of label names to filter by. Emails must have **all** specified labels.
</ParamField>
...
- When filtering by labels, emails must have **all** specified labels to be included in the results
- You can use either `label_ids` or `labels` (or both) to filter emails
